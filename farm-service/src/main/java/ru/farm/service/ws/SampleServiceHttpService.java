 ...
 * 2016-03-29T22:36:56.346+04:00
 * Generated source version: 3.1.5
 * 
 */
@WebServiceClient(name = "SampleService_HttpService", 
                  wsdlLocation = "file:/C:/Work/IdeaProjects/farm/farm-service/src/main/resources/wsdl/SampleService.wsdl",
...
public class SampleServiceHttpService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Work/IdeaProjects/farm/farm-service/src/main/resources/wsdl/SampleService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SampleServiceHttpService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Work/IdeaProjects/farm/farm-service/src/main/resources/wsdl/SampleService.wsdl");
        }
        WSDL_LOCATION = url;
    }
